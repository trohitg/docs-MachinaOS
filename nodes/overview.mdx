...
|----------|-------|-------------|
| [AI Chat Models](/nodes/ai-models) | 9 | OpenAI, Anthropic, Gemini, OpenRouter, Groq, Cerebras, DeepSeek, Kimi, Mistral |
| [AI Agents and Memory](/nodes/ai-agent) | 3 | AI Agent, Chat Agent (Zeenie), Simple Memory |
...
| [Schedulers](/nodes/schedulers) | 2 | Timer, cron scheduler |
