...
| [AI Agents](/nodes/ai-agent) | 8 | AI Agent, Chat Agent, 5 Specialized Agents, Simple Memory |
| [AI Skills](/nodes/skills) | 10 | Skill nodes for agents |
| [AI Tools](/nodes/tools) | 4 | Calculator, Time, Search, Android Toolkit |
| [WhatsApp](/nodes/whatsapp) | 3 | Messaging automation |
| [Social](/nodes/whatsapp) | 2 | Multi-platform messaging (socialReceive, socialSend) |
