---
title: Architecture
description: Deep dive into MachinaOs system architecture, execution engine, AI agents, and cache/security layers
---
...
<CardGroup cols={2}>
  ...
  <Card title="89 WebSocket Handlers" icon="bolt">
    Push-based updates replace REST polling
  </Card>
  <Card title="49 Built-in Skills" icon="wand-magic-sparkles">
